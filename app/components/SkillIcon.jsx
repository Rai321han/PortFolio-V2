export default function SkillIcon({ children }) {
  return (
    <div className="relative flex items-center justify-center">
      <div className="skillpath bg-gradient-to-r from-[#3F0005] from-0% via-[#D50C10] via-10% to-[#3F0005] to-100% px-5">
        {children}
      </div>
      ...
      <div className="lineClipUp flex items-center justify-center w-[90%] h-[3px] top-0 -translate-y-1/2 z-9 absolute bg-[#430c0d]"></div>
      <div className=" lineClipDown flex items-center justify-center w-[90%] h-[3px] bottom-0 translate-y-1/2 z-9 absolute bg-[#430c0d]"></div>
    </div>
  );
}
