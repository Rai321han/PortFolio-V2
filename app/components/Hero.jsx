...
export default function Hero() {
  return (
    ...
    >
      <div
        className={`${amaticFont.className} font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-linkHoverColor to-[#000917] to-80%  text-[120px] sm:text-[150px] md:text-[300px]`}
      >
        Raihan
      </div>
      <div
