...
export default function CustomLink({ children, ...rest }) {
  return (
    ...
    >
      ...
      <div>{children}</div>
      <div className="mt-1 bg-gradient-to-l transition duration-300 ease-out from-background from-10% via-[#149ec4] to-background to-90% group-hover:via-linkHoverColor group-hover:from-0% group-hover:to-100% w-full h-[3px]"></div>
    </Link>
  );
}
