...
export default function InfoSection({ children, title, imgSrc, imgAlt }) {
  return (
    <div className="relative border-l-2 border-primary pt-5 px-8 pr-2 sm:px-16 pb-10 ">
      <div
      ...
      <div className="absolute left-0 -translate-x-1/2 top-5 w-10 h-10">
        ...
        <div className="w-[50px] h-[50px] absolute top-0 -z-10 left-0 blur-xl bg-gradient-to-l from-background via-primary to-background"></div>
      </div>
